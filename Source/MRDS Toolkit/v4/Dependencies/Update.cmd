...
if %errorlevel% gtr 1 goto error
tf get "%~dp0..\..\..\..\..\CodeForDotNet\Build\v4.51" /recursive /noprompt
if %errorlevel% gtr 1 goto error
tfpt scorch "%~dp0..\..\..\..\..\CodeForDotNet\Build\v4.51" /recursive /diff /noprompt
if %errorlevel% gtr 1 goto error
...
if %errorlevel% gtr 7 goto error
robocopy "%~dp0..\..\..\..\..\CodeForDotNet\Build\v4.51\Release\Documentation" "%~dp0." "*Release Notes*"
if %errorlevel% gtr 7 goto error
robocopy "%~dp0..\..\..\..\..\CodeForDotNet\Build\v4.51\Release\Components" "%~dp0." *.dll *.xml *.pdb
if %errorlevel% gtr 7 goto error
attrib "%~dp0*" -r /s
